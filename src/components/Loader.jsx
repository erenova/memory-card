const Loader = () => {
  return (
    <>
      ...
      <div className="fixed -translate-x-2/4 -translate-y-2/4 top-2/4 left-2/4 text-white">
        <svg
          aria-hidden="true"
          className="w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-fuchsia-400"
          viewBox="0 0 100 101"
          fill="none"
